...
const state = reactive({
	...
	dropdownList: [
		...
		// { contextMenuClickId: 4, txt: 'message.tagsView.closeLeft', affix: false, icon: 'ele-FolderDelete' },
		// { contextMenuClickId: 5, txt: 'message.tagsView.closeRight', affix: false, icon: 'ele-FolderDelete' },
		// {
		// 	contextMenuClickId: 6,
