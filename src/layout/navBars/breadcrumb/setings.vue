<template>
  <div class="layout-breadcrumb-seting">
    <el-drawer :title="$t('message.layout.configTitle')"
      ...
      <el-scrollbar class="layout-breadcrumb-seting-bar">
        ...
        <div class="layout-breadcrumb-seting-bar-flex">
          ...
          <div class="layout-breadcrumb-seting-bar-flex-value">
            <el-color-picker v-model="getThemeConfig.primary"
                             size="default"
        ...
        <div class="layout-breadcrumb-seting-bar-flex mt15">
          ...
          <div class="layout-breadcrumb-seting-bar-flex-value">
            <el-switch v-model="getThemeConfig.isIsDark"
                       size="small"
                       @change="onAddDarkChange"></el-switch>
          </div>
        </div>
        ...
        <div class="layout-breadcrumb-seting-bar-flex">
          ...
          <div class="layout-breadcrumb-seting-bar-flex-value">
            <el-color-picker v-model="getThemeConfig.topBar"
                             size="default"
        ...
        <div class="layout-breadcrumb-seting-bar-flex">
          ...
          <div class="layout-breadcrumb-seting-bar-flex-value">
            <el-color-picker v-model="getThemeConfig.topBarColor"
                             size="default"
        ...
        <div class="layout-breadcrumb-seting-bar-flex mt10">
          ...
          <div class="layout-breadcrumb-seting-bar-flex-value">
            <el-switch v-model="getThemeConfig.isTopBarColorGradual"
                       size="small"
        ...
        <div class="layout-breadcrumb-seting-bar-flex">
          ...
          <div class="layout-breadcrumb-seting-bar-flex-value">
            <el-color-picker v-model="getThemeConfig.menuBar"
                             size="default"
                             :predefine="predefineColors"
        ...
        <div class="layout-breadcrumb-seting-bar-flex">
          ...
          <div class="layout-breadcrumb-seting-bar-flex-value">
            <el-color-picker v-model="getThemeConfig.menuBarColor"
                             size="default"
        ...
        <div class="layout-breadcrumb-seting-bar-flex">
          ...
          <div class="layout-breadcrumb-seting-bar-flex-value">
            <el-color-picker v-model="getThemeConfig.menuBarActiveColor"
                             size="default"
                             :predefine="predefineColors"
                             show-alpha
        ...
        <div class="layout-breadcrumb-seting-bar-flex mt14">
          ...
          <div class="layout-breadcrumb-seting-bar-flex-value">
            <el-switch v-model="getThemeConfig.isMenuBarColorGradual"
                       size="small"
...
const predefineColors = reactive(['#334054', '#ff8c00', '#ffd700', '#90ee90', '#00ced1']);
