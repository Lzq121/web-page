<template>
  <div class="upgrade-dialog">
    <el-dialog v-model="state.isUpgrade" width="300px" destroy-on-close :show-close="false" :close-on-click-modal="false"
      ...
      <div class="upgrade-content">
        ...
        <div class="mt5">
          <el-link type="primary" class="font12" href="https://gitee.com/huge-dream/PICC/blob/master/CHANGELOG.md"
            target="_black">
            CHANGELOG.md
          </el-link>
        </div>
