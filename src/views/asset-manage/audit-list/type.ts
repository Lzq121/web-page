...
export const AllList=[
  ...
  {
    dataIndex:"network_area_display",
    title:"部署区域",
    hidden:true
  },
...
export const appList={
  ...
  'name': '系统名称',
  'biz_class_display': '应用大类',
  'biz_type_display': '应用类别',
  'biz_plate': '所属业务板块',
  'biz_level': '等保级别',
  'biz_state': '系统状态',
  'company': '系统所属公司',
