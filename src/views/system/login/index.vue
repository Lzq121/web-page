<template>
  <div class="login-container flex z-10">
    <div class="login-left">
      <div class="login-left-logo">
        ...
        <!-- <div class="login-left-logo-text">
          <span>安全运营管理平台</span>
          <span class="login-left-logo-text-msg">人保科技</span>
        </div> -->
      </div>
    ...
    <div class="login-right flex z-10">
      <div class="login-right-warp flex-margin">
        ...
        <div class="login-right-warp-mian">
          <div class="login-right-warp-main-title">安全运营管理平台 欢迎您！</div>
    ...
    <div class="login-authorization z-10">
      <p>Copyright © https://www.picc.com/ 版权所有</p>
      <!-- <p class="la-other">
...
import logoMini from '@/assets/picc-logo.jpg';
