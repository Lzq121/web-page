<template>
  <el-form ref="formRef"
    ...
    <el-form-item class="login-animation3"
                  ...
                  prop="captcha">
      <el-col :span="15">
        <el-input @keydown.enter="loginClick"
                  type="text"
                  maxlength="4"
      ...
      <el-col :span="8">
        <el-button class="login-content-captcha">
          <el-image :src="ruleForm.captchaImgBase"
...
export default defineComponent({
	...
	setup() {
		...
		const loginSuccess = () => {
			...
			// 登录成功，跳到转运营看板
			// 如果是复制粘贴的路径，非运营看板/登录页，那么登录成功后重定向到对应的路径中
			...
			let timer = setTimeout(() => {
				if (state.ruleForm.password === 'picc@123') {
					ElMessageBox.alert('您的密码为初始密码，请尽快修改密码', '提示', {
