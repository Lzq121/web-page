<template>
  <div class="personal layout-pd">
    <el-row>
        ...
        <el-card shadow="hover"
          ...
          <div class="personal-user">
            <div class="personal-user-left">
              <avatarSelector v-model="selectImgVisible"
                              @uploadImg="uploadImg"
            ...
            <div class="personal-user-right">
              <el-row>
                <el-col :span="24"
                        class="personal-title mb18">{{ currentTime }}，{{ state.personalForm.username
                }}，生活变的再糟糕，也不妨碍我变得更好！
                </el-col>
                <el-col :span="24">
                  <el-row>
                ...
                <el-col :span="24">
                  <el-row>
                    <el-col :xs="24"
                      ...
                      <div class="personal-item-value">
                        <el-tag v-for="(item, index) in state.personalForm.role_info"
                                :key="index">{{ item.name
                        }}</el-tag>
                      </div>
                    </el-col>
      ...
      <el-col :xs="24"
        ...
        <el-card shadow="hover">
          <template #header>
            <span>消息通知</span>
            <span class="personal-info-more"
                  @click="msgMore">更多</span>
          </template>
          <div class="personal-info-box">
            <ul class="personal-info-ul">
              <li v-for="(v, k) in state.newsInfoList"
                  :key="k"
      ...
      <el-col :span="24">
        <el-card shadow="hover"
          ...
          <el-form :model="state.personalForm"
                   ref="userInfoFormRef"
                   :rules="rules"
                   size="default"
                   label-width="50px"
            ...
            <el-row :gutter="35">
              <el-col :xs="24"
                ...
                <el-form-item label="昵称"
                              prop="name">
                  <el-input v-model="state.personalForm.name"
                            placeholder="请输入昵称"
                            clearable></el-input>
                </el-form-item>
              </el-col>
              <el-col :xs="24"
                ...
                <el-form-item label="邮箱">
                  <el-input v-model="state.personalForm.email"
                            placeholder="请输入邮箱"
                            clearable></el-input>
                </el-form-item>
              </el-col>
              <el-col :xs="24"
                ...
                <el-form-item label="手机"
                              prop="mobile">
                  <el-input v-model="state.personalForm.mobile"
                            placeholder="请输入手机"
                            clearable></el-input>
                </el-form-item>
              </el-col>
              <el-col :xs="24"
                ...
                <el-form-item label="性别">
                  <el-select v-model="state.personalForm.gender"
                             placeholder="请选择性别"
                             clearable
                             class="w100">
                    ...
                    <el-option v-for="(item, index) in genderList"
                               :key="index"
                               :label="item.label"
          ...
          <div class="personal-edit-safe-box">
            <div class="personal-edit-safe-item">
              ...
              <div class="personal-edit-safe-item-right">
                <el-button text
                           type="primary"
                           @click="passwordFormShow = true">立即修改</el-button>
              </div>
            </div>
          </div>
          <div class="personal-edit-safe-box">
    ...
    <!--    密码修改-->
    <el-dialog v-model="passwordFormShow"
               title="密码修改">
      <el-form ref="userPasswordFormRef"
        ...
        <el-form-item label="原密码"
                      required
                      prop="oldPassword">
          <el-input v-model="userPasswordInfo.oldPassword"
                    placeholder="请输入原始密码"
                    clearable></el-input>
        </el-form-item>
      ...
      <template #footer>
        <span class="dialog-footer">
          <el-button type="primary"
                     @click="settingPassword"> <i class="fa fa-check"></i>提交 </el-button>
        </span>
      </template>
    </el-dialog>
  </div>
...
const validatePass = (rule: any, value: any, callback: any) => {
	const pwdRegex = new RegExp(/^\S*(?=\S{6,})(?=\S*\d)(?=\S*[A-Z])(?=\S*[a-z])(?=\S*[!@#$%^&*? ])\S*$/);
	if (value === '') {
		callback(new Error('请输入密码'));
	} else if (value === userPasswordInfo.oldPassword) {
		callback(new Error('原密码与新密码一致'));
	} else if (!pwdRegex.test(value)) {
		callback(new Error('您的密码复杂度太低(密码中必须包含大写字母、小写字母、数字、特殊字符)'));
	} else {
